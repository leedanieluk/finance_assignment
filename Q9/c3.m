...
for i=52:222
    ...
    change_in_price = c3125(counter+1:i,3) - c3125(counter:i-1,3);
    change_in_price = std((change_in_price ./ c3125(counter:i-1,3)));
...
title('Black-Scholes model on Call Options Prices for c3125')

xlabel('Time (days)') % x-axis label
ylabel('Option Price') % y-axis label

c3_mse = immse(call_prices, call_prices_estimate')
