...
for i=52:222
    ...
    change_in_price = p3025(counter+1:i,3) - p3025(counter:i-1,3);
    change_in_price = std((change_in_price ./ p3025(counter:i-1,3)));
...
title('Black-Scholes model on Put Options Prices for p3025')

xlabel('Time (days)') % x-axis label
ylabel('Option Price') % y-axis label

p2_mse = immse(call_prices, call_prices_estimate')
